    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text="Phone number must be exactly 10 digits and start with '07'", max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^07\\d{8}$', 'Phone number must be exactly 10 digits and must be a rwandan Number.')])),
